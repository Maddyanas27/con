...
<link rel="stylesheet" href="css/premium-product.css">
...
<!-- Product -->
	<div class="bg0 m-t-23 p-b-140">
		<div class="container">
			<div class="text-center mb-5">
				<h1 class="display-4" style="color: #B8860B; font-family: 'Playfair Display', serif;">Our Collection</h1>
				<p class="lead">Discover our premium selection of products</p>
			</div>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item">
					<div class="block2">
						...
						<div class="block2-txt">
							<h4>
								<a href="product-detail.php?detail_id=<?php echo $row['id']; ?>" class="js-name-b2">
									<?php echo $row['name']; ?>
								</a>
							</h4>
	...
	<script src="js/premium-product.js"></script>
